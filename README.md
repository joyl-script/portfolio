...
Next.js-приложение: каталог, карточки товаров, [добавь сюда 1-2 реальные фичи — корзина? фильтры? авторизация?].
...
Адаптивная вёрстка лендинга онлайн-кинотеатра: hero-секция, модалки логина/регистрации, футер с соцсетями.
